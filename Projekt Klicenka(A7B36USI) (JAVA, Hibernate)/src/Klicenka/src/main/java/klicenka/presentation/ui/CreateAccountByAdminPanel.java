...
/**
 * 
 * JPanel pro vytvařeni uživatele administratorem
 *
 */
public class CreateAccountByAdminPanel extends JPanel {
	...
	public CreateAccountByAdminPanel() {
		setLayout(null);
		...
		sendButton = new JButton("Vytvařit uživatele");
